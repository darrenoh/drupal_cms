...
cd "$APP_ROOT" && time composer create-project -n --no-install drupal/cms
cd "$APP_ROOT" && cp -r "$APP_ROOT"/cms/* "$APP_ROOT"/.
rm -rf "$APP_ROOT"/cms
...
cd "${APP_ROOT}" &&
    ...
    composer config \
        repositories."jquery.intl-tel-input" \
        '{
            "type": "package",
            "package": {
    ...
    composer config \
        repositories."jquery.textcounter" \
        '{
            "type": "package",
            "package": {
    ...
    composer config \
        repositories."jquery.timepicker" \
        '{
            "type": "package",
            "package": {
